...
const getAppointmentModel = (clinicId, clinicName) => {
    ...
    const schema = new mongoose.Schema({
        clinic_id: String,   // Using string for consistency with env
        clinic_name: String,
        patient_name: String,
        service: String,
        phone: String,
...
const handleBookingSteps = async (clinicConfig, session, fromNumber, msg) => {
    ...
    const Appointment = getAppointmentModel(clinicConfig.clinic_id, clinicConfig.clinic_name);
